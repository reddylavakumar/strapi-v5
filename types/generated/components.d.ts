...
export interface ComponentsCaseStudy extends Schema.Component {
  ...
  attributes: {
    CustomerLight: Attribute.Media & Attribute.Required;
    CustomerDark: Attribute.Media & Attribute.Required;
    CoverLight: Attribute.Media & Attribute.Required;
    CoverDark: Attribute.Media & Attribute.Required;
